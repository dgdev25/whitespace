...
class Settings(BaseSettings):
    ...
    arxiv_categories: str = (
        "cs.AI,cs.LG,cs.NE,stat.ML,cs.CL,cs.IR,cs.CV,eess.IV,cs.AR,cs.DC,cs.PL,"
        "cs.SE,cs.SY,eess.SY,cs.CR,cs.DB,cs.GT,cs.HC,cs.MA,cs.RO,eess.AS,eess.SP,"
        "math.OC,stat.AP,q-bio.NC"
    )
    ideas_per_run: int = 5
